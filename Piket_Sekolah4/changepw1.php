  ...
  <ul class="navbar-nav justify-content-end">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item active" href="changepw1.php">Ganti Password</a>     
    ...
    <form class="form-signin" method="post" action="">      
      ...
      <label for="inputPassword" name="password" class="sr-only">Password Sekarang</label>
      <input type="password" name="oldpass" id="inputPassword" class="form-control" placeholder="Password Sekarang" required>
      


      
      <label for="inputPassword" name="password" class="sr-only">Password Baru</label>
      <input type="password" name="newpass" id="inputPassword" class="form-control" placeholder="Password Baru" required>
      


      
      <label for="inputPassword" name="password" class="sr-only">Konfirmasi Password</label>
